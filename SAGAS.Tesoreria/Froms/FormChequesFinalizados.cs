...
{
    public partial class FormChequesFinalizados : Parametros.Forms.FormBase
    {
        ...
        public FormChequesFinalizados()
        {
            try
            {
                InitializeComponent();
                this.btnAnular.Caption = "Cancelar Cheque";
                this.barImprimir.Caption = "Re Imprimir";         
                this.btnAgregar.Visibility = BarItemVisibility.Never;
        ...
        protected override void Imprimir()
        {
            if (gvData.FocusedRowHandle >= 0)
            {
                if (!Convert.ToBoolean(gvData.GetFocusedRowCellValue(colAnulado)))
                {
                    ...
                    Parametros.General.DialogMsg("El cheque esta ANULADO", Parametros.MsgType.warning);
            }
        }
