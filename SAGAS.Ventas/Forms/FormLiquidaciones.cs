...
{                                
    public partial class FormLiquidaciones : Parametros.Forms.FormBase
    {
        #region <<< DECLARACIONES >>>

        private Forms.Dialogs.DialogLiquidacion nf;
        ...
        private void linqInstantFeedbackSource1_GetQueryable(object sender, GetQueryableEventArgs e)
        {
            try
            {
                ...
                var query = from iv in dv.VistaMovimientos.Where(v => v.MovimientoTipoID.Equals(49) || v.MovimientoTipoID.Equals(50))
        ...
        protected override void Add()
        {
            try
            {
                if (nf == null)
                {
                    nf = new Forms.Dialogs.DialogLiquidacion(Usuario);
                    nf.Text = "Nueva Liquidación";
                    nf.Owner = this.Owner;
            ...
            using (System.Data.Common.DbTransaction trans = db.Connection.BeginTransaction())
            {
                ...
                try
                {
                    ...
                    Parametros.General.AddLogBook(db, Parametros.TipoAccion.Ventas,
                        "Se anuló la liquidación : " + Manterior.Numero, this.Name);
                    db.SubmitChanges();                    
                    trans.Commit();
