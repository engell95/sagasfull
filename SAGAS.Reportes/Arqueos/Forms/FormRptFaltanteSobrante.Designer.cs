...
{
    partial class FormRptFaltanteSobrante
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormRptFaltanteSobrante));
            ...
            this.colFaltanteSobrante = new DevExpress.XtraGrid.Columns.GridColumn();
            this.colDiferenciaRecibida = new DevExpress.XtraGrid.Columns.GridColumn();
            ...
            this.colTipo.ColumnEdit = this.rpTipo;
            ...
            this.colFaltanteSobrante,
            this.colTipo,
            this.colDiferenciaRecibida});
            styleFormatCondition1.Appearance.ForeColor = System.Drawing.Color.Red;
            styleFormatCondition1.Appearance.Options.UseForeColor = true;
            styleFormatCondition1.Column = this.colTipo;
            styleFormatCondition1.Condition = DevExpress.XtraGrid.FormatConditionEnum.Expression;
            styleFormatCondition1.Expression = "[Tipo] == 2";
            ...
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "FaltanteSobrante", null, "Total Faltante / Sobrante  = {0:#,0.00;(#,0.00)}"),
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "DiferenciaRecibida", null, "Total Diferencia Recibia   = {0:#,0.00;(#,0.00)}")});
            ...
            // colResumenDiaNumero
            // 
            this.colResumenDiaNumero.Caption = "No. Resumen";
            ...
            // colArqueoNumero
            // 
            this.colArqueoNumero.Caption = "No. Arqueo";
            ...
            this.colTecnicoNombre.OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains;
            this.colTecnicoNombre.Visible = true;
            this.colTecnicoNombre.VisibleIndex = 6;
            this.colTecnicoNombre.Width = 201;
            // 
            // colFaltanteSobrante
            // 
            this.colFaltanteSobrante.Caption = "Faltante / Sobrante";
            this.colFaltanteSobrante.DisplayFormat.FormatString = "n2";
            this.colFaltanteSobrante.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            this.colFaltanteSobrante.FieldName = "SobranteFaltante";
            this.colFaltanteSobrante.GroupFormat.FormatString = "n2";
            this.colFaltanteSobrante.GroupFormat.FormatType = DevExpress.Utils.FormatType.Numeric;
            this.colFaltanteSobrante.Name = "colFaltanteSobrante";
            this.colFaltanteSobrante.OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains;
            this.colFaltanteSobrante.Summary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "SobranteFaltante", "{0:#,0.00;(#,0.00)}")});
            this.colFaltanteSobrante.UnboundType = DevExpress.Data.UnboundColumnType.Decimal;
            this.colFaltanteSobrante.Visible = true;
            this.colFaltanteSobrante.VisibleIndex = 7;
            this.colFaltanteSobrante.Width = 116;
            // 
            // colDiferenciaRecibida
            // 
            this.colDiferenciaRecibida.Caption = "Diferencia Recibida ";
            this.colDiferenciaRecibida.FieldName = "DiferenciaRecibida";
            this.colDiferenciaRecibida.Name = "colDiferenciaRecibida";
            this.colDiferenciaRecibida.OptionsFilter.AutoFilterCondition = DevExpress.XtraGrid.Columns.AutoFilterCondition.Contains;
            this.colDiferenciaRecibida.Summary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "DiferenciaRecibida", "{0:#,0.00;(#,0.00)}")});
            this.colDiferenciaRecibida.UnboundType = DevExpress.Data.UnboundColumnType.Decimal;
            this.colDiferenciaRecibida.Visible = true;
            this.colDiferenciaRecibida.VisibleIndex = 8;
            this.colDiferenciaRecibida.Width = 106;
            // 
            // rpEstacionServicio
            // 
            ...
            this.Name = "FormRptFaltanteSobrante";
            this.Text = "Reporte de Faltante / Sobrante";
        ...
        private DevExpress.XtraGrid.Columns.GridColumn colFaltanteSobrante;
        private DevExpress.XtraGrid.Columns.GridColumn colDiferenciaRecibida;
